...
import {View, Text, TextInput, TouchableOpacity, Image} from 'react-native'; // Asegúrate de incluir Image
	...
	return (
		<View>
			<View style={style_01.titleBar}>
				<Image source={require('../imgs/logos/logo_universidad.png')} /> {/* Componente Image */}
